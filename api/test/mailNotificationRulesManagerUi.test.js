...
test('mail reminder rules manager is keyboard accessible and restores focus', async () => {
  ...
  assert.match(manager, /focusInlineConfirmation/)
  assert.match(manager, /restoreInlineActionFocus/)
  assert.match(manager, /data-rule-action="toggle"/)
  assert.match(manager, /data-rule-action="delete"/)
